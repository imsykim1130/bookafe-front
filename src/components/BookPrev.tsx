  ...
  return (
    <article className={`w-full cursor-pointer flex flex-col`} onClick={bookImgClickHandler}>
      <img
        src={bookImg}
        alt="book image"
        className={`w-full my-[15px] rounded-[10px] transition-all duration-500 ease shadow-[2px_2px_10px_rgba(0,0,0,0.6)] hover:shadow-[6px_6px_10px_rgba(0,0,0,0.6)] hover:translate-y-[-10px] hover:scale-105`}
      />
